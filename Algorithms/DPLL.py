...
TIME_LIMIT = 120  # Set your time limit in seconds
...
def unit_propagate(clauses, assignment):
    ...
    while changed:
        ...
        for clause in unit_clauses:
            ...
            clauses = new_clauses
            changed = True
            break  # re-evaluate unit clauses
    return clauses
...
def dpll(clauses, assignment, start_time):
    ...
    # Choose next variable to assign (naive)
...
def main():
    filename = "cnf_6v_30c_SAT_1.cnf"  # Change this to your CNF file
    ...
    if result:
        print("Model (example satisfying assignment):", assignment)
